...
This is a plot of the FUSION output for average height. Notice that there don't appear to be and artifacts
related to flightlines. These data were collected using flightlines running from the SE to NW (and
NW to SE) with low sidelap. Looking at some of the comparison plots (next the histograms), there appear to 
be some patterns that match the areas of flightline overlap.
