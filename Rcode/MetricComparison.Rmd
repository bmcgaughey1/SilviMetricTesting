...
Looking closely at the following plots, I don't see many empty (red) cells (NODATA or NA values for cells) 
in the FUSION output but do see some in the SilviMetric output. Not really sure why this is the case.
...
plot(r, main = "SilviMetric -- CHM", colNA = "red")
